package de.dontknow.gitlabpipelines.window;
...
public class Window implements ToolWindowFactory, DumbAware {
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        // Create a panel to hold your tool window components.
        JPanel panel = new JPanel();
        panel.add(new JLabel("Hello, IntelliJ Plugin Tool Window!"));

        // Create the content using ContentFactory and add it to the tool window.
